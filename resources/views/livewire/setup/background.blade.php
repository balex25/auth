        ...
        <div class="w-full h-auto">
            ...
            @else
                <div class="flex justify-center items-center w-full">
                    <label for="image" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-neutral-800 dark:bg-neutral-700 hover:bg-gray-100 dark:border-neutral-600 dark:hover:border-neutral-500 dark:hover:bg-neutral-600">
                        <div class="flex flex-col justify-center items-center pt-5 pb-6">
                            <svg class="mb-4 w-8 h-8 text-gray-500 dark:text-neutral-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                            </svg>
                            <p class="mb-2 text-sm text-gray-500 dark:text-neutral-400"><span class="font-semibold">Click to upload</span></p>
                            <p class="text-xs text-gray-500 dark:text-neutral-400">PNG, JPG or GIF</p>
                        </div>
    ...
    <div class="pb-5 mb-5 border-b border-zinc-200">
        ...
        <div class="w-full h-auto">
            ...
            <div class="relative mb-6 max-w-xs">
                <input type="range" value="100" min="0" max="100" x-model="image_overlay_opacity" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-neutral-700">
