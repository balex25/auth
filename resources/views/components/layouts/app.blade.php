...
<body id="auth-body" class="overflow-hidden relative w-screen h-screen" style="background-color:{{ config('devdojo.auth.appearance.background.color') }}">
    ...
    >
        ...
        <div class="flex fixed bottom-5 right-5 z-40 items-center gap-2 max-[848px]:left-8" data-auth-footer-controls>
            <a href="{{ \Devdojo\Auth\Helper::localizedUrl('/') }}" class="inline-flex min-h-9 items-center justify-center rounded-lg border border-white/20 bg-white/10 px-2.5 py-1.5 text-xs font-medium text-white shadow-md backdrop-blur-md transition hover:bg-white/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 active:scale-95 max-[848px]:border-transparent max-[848px]:bg-transparent max-[848px]:hover:bg-white/10 min-[848px]:[text-shadow:1px_1px_1px_#000]">
            ...
            >
                <button type="button" class="inline-flex min-h-9 cursor-pointer items-center gap-2 rounded-lg border border-white/20 bg-white/10 px-2.5 py-2 text-xs font-semibold text-white shadow-md backdrop-blur-md transition hover:bg-white/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 max-[848px]:border-transparent max-[848px]:bg-transparent max-[848px]:hover:bg-white/10 min-[848px]:[text-shadow:1px_1px_1px_#000]" x-on:click="open = !open" x-bind:aria-expanded="open.toString()" aria-haspopup="menu" aria-label="{{ __('header.dropdown.language') }}">
            ...
            <div
                ...
                x-on:keydown.escape.window="open = false"
            >
                <button type="button" class="inline-flex min-h-9 cursor-pointer items-center gap-2 rounded-lg border border-white/20 bg-white/10 px-2.5 py-2 text-xs font-semibold text-white shadow-md backdrop-blur-md transition hover:bg-white/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 max-[848px]:border-transparent max-[848px]:bg-transparent max-[848px]:hover:bg-white/10 min-[848px]:[text-shadow:1px_1px_1px_#000]" x-on:click="open = !open" x-bind:aria-expanded="open.toString()" aria-haspopup="menu" aria-label="{{ __('header.dropdown.dark_mode') }}">
            ...
            <div class="relative z-10 m-1 min-w-0 overflow-hidden rounded-lg border border-gray-200 bg-white px-3 py-2 pb-3 text-left text-gray-900 shadow-sm dark:border-neutral-700 dark:bg-neutral-800 dark:text-white">
                ...
                >
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3.5 shrink-0"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>
                    </h3>
                </a>
                    ...
                    >
                        ...
                        <span class="inline-flex min-w-0 items-center gap-1">
                            ...
                            <span x-show="currentBackground() && currentBackground().author_verified" x-cloak class="inline-flex shrink-0" data-auth-background-verified-badge>
                                <x-auth::elements.verified-badge />
                            </span>
