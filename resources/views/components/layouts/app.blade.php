...
<body id="auth-body" class="overflow-hidden relative w-screen h-screen" style="background-color:{{ config('devdojo.auth.appearance.background.color') }}">
    ...
    >
        ...
        <div class="flex fixed bottom-5 left-8 z-40 items-center gap-2 w-[calc(100%-4rem)] sm:max-w-[calc(var(--container-md)-4rem)]" data-auth-footer-controls>
            <a href="{{ \Devdojo\Auth\Helper::localizedUrl('/') }}" class="inline-flex min-h-9 items-center justify-center rounded-lg border border-transparent bg-transparent px-2.5 py-1.5 text-xs font-medium text-white transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 active:scale-95 backdrop-blur-md">
            ...
            >
                <button type="button" class="inline-flex min-h-9 cursor-pointer items-center gap-2 rounded-lg border border-transparent bg-transparent px-2.5 py-2 text-xs font-semibold text-white transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 backdrop-blur-md" x-on:click="open = !open" x-bind:aria-expanded="open.toString()" aria-haspopup="menu" aria-label="{{ __('header.dropdown.language') }}">
            ...
            <div
                ...
                x-on:keydown.escape.window="open = false"
            >
                <button type="button" class="inline-flex min-h-9 cursor-pointer items-center gap-2 rounded-lg border border-transparent bg-transparent px-2.5 py-2 text-xs font-semibold text-white transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/70 backdrop-blur-md" x-on:click="open = !open" x-bind:aria-expanded="open.toString()" aria-haspopup="menu" aria-label="{{ __('header.dropdown.dark_mode') }}">
